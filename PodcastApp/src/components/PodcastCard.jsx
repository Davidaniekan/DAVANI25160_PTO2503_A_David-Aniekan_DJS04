...
export default function PodcastCard({ podcast, genres = [] }) {
  const { setSelectedId } = useContext(PodcastContext);
   ...
   * Intended to open a modal or detail view in the future.
   */
  const onSelect = () => {
    if (typeof setSelectedId === "function") setSelectedId(podcast.id);
  };
